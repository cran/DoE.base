...
###   lengths contr.XuWu contr.XuWuPoly P3.3 P4.4 GR oa.min3 oa.min34
###   oa.max3 oa.max4 oa.maxGR oa.minRelProjAberr nchoosek tupleSel
###   tupleSel.design tupleSel.default
